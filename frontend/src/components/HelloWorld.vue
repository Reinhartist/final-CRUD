    ...
    <div class="service">
        ...
        <b-input-group class="row justify-content-md-center">
            <b-input-group-append>
                ...
                <b-button @click="create = !create; editConfirm = -1; resetForm()">
                    Create
                </b-button>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center"
                ...
                <div v-if="msg === 'Projects' && editConfirm !== -1">
                    <b-form-input pattern="[1-9][0-9]*" placeholder="Worker account"
                                  v-model="resourceOwner">
                    </b-form-input>
        ...
        <b-table striped hover dark table-bordered :items="response"
            ...
            <template slot="actions" slot-scope="row">
                ...
                <b-button v-if="deleteConfirm === row.index" variant="success"
                          @click="deleteById(row.item, row.index); deleteConfirm = -1">Confirm
                </b-button>
